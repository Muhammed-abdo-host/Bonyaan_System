  ...
  <section id="view-about" class="view-section active animated-fade py-5">
    <div class="container py-4">
      <div class="text-center max-w-700 mx-auto mb-5">
        ...
        <p class="lead text-muted">Founded in 2002, Bonyaan has evolved into a premier full-service contracting powerhouse delivering architectural landmarks across the region.</p>
      </div>
      ...
      <div class="row g-4 mb-5">
        <div class="col-md-4">
          <div class="glass-card p-4 text-center h-100">
            ...
            <h5 class="fw-bold text-met-navy mb-2">Uncompromising Quality</h5>
            <p class="small text-muted mb-0">ISO 9001:2015 certified quality controls ensure zero structural defect tolerances.</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="glass-card p-4 text-center h-100">
            <i class="bi bi-cpu text-gold fs-1 mb-3"></i>
            <h5 class="fw-bold text-met-navy mb-2">Advanced Technology</h5>
            <p class="small text-muted mb-0">BIM 3D modeling, automated drone inspections, and real-time client portal tracking.</p>
          </div>
        </div>
        <div class="col-md-4">
          <div class="glass-card p-4 text-center h-100">
            <i class="bi bi-hand-thumbs-up text-gold fs-1 mb-3"></i>
            <h5 class="fw-bold text-met-navy mb-2">Transparent Ethics</h5>
            <p class="small text-muted mb-0">Clear contracts, predictable financial milestones, and zero hidden costs.</p>
          </div>
        </div>
      </div>
      ...
      <div class="text-center mb-4">
        <span class="badge badge-gold mb-2">Our Team</span>
        <h3 class="fw-bold text-met-navy m-0">Executive Leadership Team</h3>
      </div>

      <div class="row g-4">
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="glass-card overflow-hidden text-center p-3 h-100">
