      ...
      <div class="row align-items-center g-5">
        <div class="col-lg-7">
          ...
          <div class="d-flex flex-wrap align-items-center gap-3">
            <a class="btn btn-met-gold btn-lg d-flex align-items-center gap-2 shadow" href="{{ url('/estimator') }}">
              <i class="bi bi-calculator-fill"></i>
              <span>Calculate Construction Cost</span>
            </a>
            <a class="btn btn-met-outline btn-lg d-flex align-items-center gap-2" href="{{ url('/projects') }}">
        ...
        <div class="col-lg-5">
          <div class="glass-card-dark p-4 rounded-4 shadow-lg border border-secondary">
            ...
            <a class="btn btn-met-gold w-100 py-2.5 fw-bold text-center text-decoration-none d-block" href="{{ url('/estimator') }}">
    ...
    <div class="container py-4">
      <div class="row align-items-center g-5">
        ...
        <div class="col-lg-6">
          ...
          <a class="btn btn-met-navy btn-lg text-white d-inline-flex align-items-center gap-2" href="{{ url('/about') }}">
      ...
      <div class="row g-4">
        <div class="col-lg-4 col-md-6">
          <div class="service-card">
            ...
            <a class="btn btn-link text-decoration-none text-gold p-0 fw-bold d-flex align-items-center gap-1" href="{{ url('/services') }}">
  ...
  <div class="py-5 bg-light">
    <div class="container py-4">
      <div class="d-flex flex-wrap align-items-end justify-content-between mb-4 gap-3">
        ...
        <a class="btn btn-outline-dark fw-bold text-decoration-none" href="{{ url('/projects') }}">
